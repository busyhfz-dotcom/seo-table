...
export const RULE_DESCRIPTIONS_FA: Record<string, string> = {
  "rule.title.missing": "صفحه‌ی قابل ایندکس عنصر <title> ندارد یا خالی است.",
  ...
  "rule.robots.blocks_sitemap_url": "نشانی‌ای که در sitemap آمده با robots.txt مسدود شده است.",
  ...
  "rule.sitemap.missing": "هیچ sitemapی از طریق robots.txt یا ‎/sitemap.xml پیدا نشد.",
  "rule.sitemap.page_missing": "یک صفحه‌ی قابل ایندکس در sitemap نیامده است.",
  "rule.sitemap.url_not_indexable": "sitemap نشانی‌ای دارد که خطا می‌دهد، ریدایرکت می‌شود یا noindex است.",
  "rule.sitemap.redirect": "sitemap به‌جای مقصد، نشانی ریدایرکت‌شونده را فهرست کرده است.",
  ...
  "rule.links.nofollow_internal": "یک لینک داخلی rel=nofollow دارد و اعتبار لینک هدر می‌رود.",
    ...
    pick(
      {
        ...
        meta_none: { fa: "noindex (none)", en: "noindex (none)" },
